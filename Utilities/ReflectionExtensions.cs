...
public static class ReflectionExtensions
{
    ...
    /// <exception cref="ArgumentNullException"><paramref name="element"/> is <see langword="null"/>.</exception>
    [Pure]
    public static bool TryGetCustomAttribute<T>(this ParameterInfo element, [NotNullWhen(true)] out T? attribute) where T : Attribute
        => TryGetCustomAttributeCore((T[])element.GetCustomAttributes<T>(), out attribute);

    [Pure]
    private static bool TryGetCustomAttributeCore<T>(T[] attributes, [NotNullWhen(true)] out T? attribute) where T : Attribute
    {
    ...
    [Pure]
    private static Nullability GetNullabilityCore(Type type, MemberInfo? parent, IList<CustomAttributeData> attributes)
    {
    ...
    [Pure]
    private static object? GetNullabilityFirstAttributeValue(IList<CustomAttributeData> attributes, string attrName)
    {
